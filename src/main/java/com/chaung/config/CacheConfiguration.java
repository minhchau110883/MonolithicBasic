...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, com.chaung.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, com.chaung.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            createCache(cm, com.chaung.domain.User.class.getName(), jcacheConfiguration);
            createCache(cm, com.chaung.domain.Authority.class.getName(), jcacheConfiguration);
            createCache(cm, com.chaung.domain.User.class.getName() + ".authorities", jcacheConfiguration);
